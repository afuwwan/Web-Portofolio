    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">
                <span class="d-block d-lg-none">Xtrant</span>
        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    <h1 class="mb-0">
                        Ismail
                        <span class="text-primary">Extrant</span>
                    </h1>
                    ...
                    <p class="lead mb-5">"The best way to predict the future is to create it, regardless of what others say."</p>
            ...
            <section class="resume-section" id="education">
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        ...
                        <div class="flex-shrink-0"><span class="text-primary">{{ $item->tahun_mulai }} - {{ $item->tahun_akhir }}</span></div>
                    </div>
                    @endforeach
                </div>
            </section>
            ...
            <section class="resume-section" id="interests">
                <div class="resume-section-content">
                    <h2 class="mb-5">{{ $halamanInterest->judul }}</h2>
                    <p>{{ $halamanInterest->isi }}</p>
                </div>
            </section>
            <hr class="m-0" />
            <!-- Awards-->
            <section class="resume-section" id="awards">
                <div class="resume-section-content">
                    <h2 class="mb-5">{{ $halamanAward->judul }}</h2>
                    <p>{{ $halamanAward->isi }}</p>
                </div>
            </section>
        </div>
        <!-- Bootstrap core JS-->
